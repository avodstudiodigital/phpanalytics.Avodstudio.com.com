! function(e, t) {
    ...
    var x = function(e) {
        ...
        function xe(e, t, n, r, i, o) {
            return r && !r[_] && (r = xe(r)), i && !i[_] && (i = xe(i, o)), ue((function(o, a, s, l) {
                ...
                } else v = Ee(v === a ? v.splice(p, v.length) : v), i ? i(null, a, v, l) : q.apply(a, v)
            }))
        }
        ...
        return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function(e, t) {
            ...
            if (!g) {
                ...
                (g = S(e, (i = p, s = 0 < (o = f).length, l = 0 < i.length, c = function(e, t, n, a, c) {
                    var f, p, g, v = 0,
                        y = "0",
                        b = e && [],
                        _ = [],
                    ...
                    if (v += y, s && y !== v) {
                        ...
                        if (e) {
                            if (0 < v)
                                for (; y--;) b[y] || _[y] || (_[y] = L.call(a));
                            _ = Ee(_)
                        }
                        q.apply(a, _), c && !e && 0 < _.length && 1 < v + o.length && se.uniqueSort(a)
                    }
                    return c && (E = T, u = w), b
                }, s ? ue(c) : c))).selector = e
            }
    ...
    w.fn.extend({
        ...
        w.fn[e] = function(n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = w.filter(r, i)), 1 < this.length && (q[e] || w.uniqueSort(i), j.test(e) && i.reverse()), this.pushStack(i)
        }
    }));
    var I = /[^\x20\t\r\n\f]+/g;
                ...
                i = {
                    ...
                    then: function(t, r, i) {
                                ...
                                var s = this,
                                    ...
                                    u = function() {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            u = e && ("object" == typeof e || "function" == typeof e) && e.then, p(u) ? i ? u.call(e, a(o, n, P, i), a(o, n, R, i)) : (o++, u.call(e, a(o, n, P, i), a(o, n, R, i), a(o, n, P, n.notifyWith))) : (r !== P && (s = void 0, l = [e]), (i || n.resolveWith)(s, l))
                                        }
                                    },
                                    c = i ? u : function() {
                                        try {
                                            ...
                                            w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace), o <= t + 1 && (r !== R && (s = void 0, l = [e]), n.rejectWith(s, l))
                                        }
                                    };
                        ...
                        return w.Deferred((function(e) {
                            n[0][3].add(a(0, e, p(i) ? i : P, e.notifyWith)), n[1][3].add(a(0, e, p(t) ? t : P)), n[2][3].add(a(0, e, p(r) ? r : R))
                        })).promise()
                    },
                    promise: function(e) {
    ...
    w.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && k(t, "input") && Ce(t, "click", we), !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && k(t, "input") && Ce(t, "click"), !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function qe(e, t, n, r) {
        ...
        if (v || 1 < d && "string" == typeof g && !h.checkClone && ke.test(g)) return e.each((function(i) {
            var o = e.eq(i);
            v && (t[0] = g.call(this, i, o.html())), qe(o, t, n, r)
        }));
        if (d && (a = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            ...
            if (l)
                for (c = s[s.length - 1].ownerDocument, w.map(s, Le), f = 0; f < l; f++) u = s[f], pe.test(u.type || "") && !Y.access(u, "globalEval") && w.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? w._evalUrl && !u.noModule && w._evalUrl(u.src, {
    ...
    function We(e, t, n) {
        var r, i, o, a, s = Pe.test(t),
            l = e.style;
        return (n = n || Re(e)) && (a = n.getPropertyValue(t) || n[t], s && a && (a = a.replace(Be, "$1") || void 0), "" !== a || ie(e) || (a = w.style(e, t)), !h.pixelBoxStyles() && Ie.test(a) && Me.test(t) && (r = l.width, i = l.minWidth, o = l.maxWidth, l.minWidth = l.maxWidth = l.width = a, a = n.width, l.width = r, l.minWidth = i, l.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    w.extend({
        ...
        css: function(e, t, n, r) {
            var i, o, a, s = z(t);
            return Pe.test(t) || (t = Ve(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = We(e, t, r)), "normal" === i && t in Ke && (i = Ke[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
...
function(e, t) {
    ...
    r.default(document).on(C, A, (function(e) {
        var t = e.target,
            n = t;
        if (r.default(t).hasClass("btn") || (t = r.default(t).closest(D)[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
            ...
            "INPUT" !== n.tagName && "LABEL" === t.tagName || L._jQueryInterface.call(r.default(t), "toggle", "INPUT" === n.tagName)
        }
    })).on(S, A, (function(e) {
    ...
    })), r.default.fn[b] = L._jQueryInterface, r.default.fn[b].Constructor = L, r.default.fn[b].noConflict = function() {
        return r.default.fn[b] = x, L._jQueryInterface
    };
    var j = "carousel",
        q = "bs.carousel",
        O = "." + q,
        ...
        re = function() {
            ...
            return t.next = function() {
                ...
                r.default(this._element).off(O), r.default.removeData(this._element, q), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, t._getConfig = function(e) {
                return e = a({}, ee, e), c.typeCheckConfig(j, e, te), e
                ...
                if (e === H ? (n = "carousel-item-left", i = "carousel-item-next", o = "left") : (n = "carousel-item-right", i = "carousel-item-prev", o = "right"), u && r.default(u).hasClass(R)) this._isSliding = !1;
                    ...
                    if (r.default(this._element).hasClass("slide")) {
                        ...
                        r.default(s).one(c.TRANSITION_END, (function() {
                            r.default(u).removeClass(n + " " + i).addClass(R), r.default(s).removeClass(R + " " + i + " " + n), a._isSliding = !1, setTimeout((function() {
                                return r.default(a._element).trigger(h)
                            }), 0)
                        })).emulateTransitionEnd(p)
                    } else r.default(s).removeClass(R), r.default(u).addClass(R), this._isSliding = !1, r.default(this._element).trigger(h);
                    d && this.cycle()
                }
            }, e._jQueryInterface = function(t) {
                return this.each((function() {
                    ...
                    if (n || (n = new e(this, i), r.default(this).data(q, n)), "number" == typeof t) n.to(t);
                ...
                if (n) {
                    ...
                    if (i && r.default(i).hasClass("carousel")) {
                        ...
                        s && (o.interval = !1), e._jQueryInterface.call(r.default(i), o), s && r.default(i).data(q).to(s), t.preventDefault()
                    }
                }
            }, o(e, null, [{
                key: "VERSION",
    ...
    r.default(document).on(J, "[data-slide], [data-slide-to]", re._dataApiClickHandler), r.default(window).on(G, (function() {
        ...
        return r.default.fn[j] = P, re._jQueryInterface
    };
    var ie = "collapse",
        oe = "bs.collapse",
        ae = "." + oe,
    ...
    var De = Ee && !(!window.MSInputMethodContext || !document.documentMode),
        Le = Ee && /MSIE 10/.test(navigator.userAgent);

    function je(e) {
        return 11 === e ? De : 10 === e ? Le : De || Le
    }
    ...
    function qe(e) {
        ...
        var r = n && n.nodeName;
        return r && "BODY" !== r && "HTML" !== r ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === Se(n, "position") ? qe(n) : n : e ? e.ownerDocument.documentElement : document.documentElement
    }
    ...
    function Ie(e, t) {
        ...
        if (e !== l && t !== l || r.contains(i)) return "BODY" === (s = (a = l).nodeName) || "HTML" !== s && qe(a.firstElementChild) !== a ? qe(l) : l;
        var u = Oe(e);
    ...
    function Me(e, t, n, r) {
        return Math.max(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], je(10) ? parseInt(n["offset" + e]) + parseInt(r["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(r["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
    }
    ...
    function Ve(e, t) {
        ...
        return (r && !n ? t.contains(s) : t === s && "BODY" !== s.nodeName) && (f = Re(f, t)), f
    }
    ...
    function Ye(e) {
        ...
        if ("fixed" === Se(e, "position")) return !0;
        var n = ke(e);
        return !!n && Ye(n)
    }
    ...
    function ot(e, t, n) {
        return (void 0 === n ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && Ce(n) && (t.offsets.popper = $e(t.offsets.popper), t.offsets.reference = $e(t.offsets.reference), t = n(t, e))
        })), t
    }
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var n = t.offset,
                        ...
                        s = r.split("-")[0],
                        l = void 0;
                    return l = mt(+n) ? [+n, 0] : Ct(n, o, a, s), "left" === s ? (o.top += l[0], o.left -= l[1]) : "right" === s ? (o.top += l[0], o.left += l[1]) : "top" === s ? (o.left += l[0], o.top -= l[1]) : "bottom" === s && (o.left += l[0], o.top += l[1]), e.popper = o, e
                },
                offset: 0
            },
            preventOverflow: {
        ...
        At = function() {
            function e(t, n) {
                ...
                Be(this, e), this.scheduleUpdate = function() {
                    ...
                    e.enabled && Ce(e.onLoad) && e.onLoad(r.reference, r.popper, r.options, e, r.state)
                })), this.update();
    ...
    var Nt = At,
        ...
        Gt = function() {
            ...
            var t = e.prototype;
            return t.toggle = function() {
                if (!this._element.disabled && !r.default(this._element).hasClass(Pt)) {
                    var t = r.default(this._menu).hasClass(Rt);
                    e._clearMenus(), t || this.show(!0)
                }
            }, t.show = function(t) {
                if (void 0 === t && (t = !1), !(this._element.disabled || r.default(this._element).hasClass(Pt) || r.default(this._menu).hasClass(Rt))) {
                    var n = {
                    ...
                    if (r.default(o).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar && t) {
                            ...
                            var a = this._element;
                            "parent" === this._config.reference ? a = o : c.isElement(this._config.reference) && (a = this._config.reference, void 0 !== this._config.reference.jquery && (a = this._config.reference[0])), "scrollParent" !== this._config.boundary && r.default(o).addClass("position-static"), this._popper = new Nt(a, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === r.default(o).closest(".navbar-nav").length && r.default(document.body).children().on("mouseover", null, r.default.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), r.default(this._menu).toggleClass(Rt), r.default(o).toggleClass(Rt).trigger(r.default.Event(Wt, n))
                    }
                }
            }, t.hide = function() {
                if (!this._element.disabled && !r.default(this._element).hasClass(Pt) && r.default(this._menu).hasClass(Rt)) {
                    var t = {
                            relatedTarget: this._element
                        },
                        n = r.default.Event(Mt, t),
                        i = e._getParentFromElement(this._element);
                    r.default(i).trigger(n), n.isDefaultPrevented() || (this._popper && this._popper.destroy(), r.default(this._menu).toggleClass(Rt), r.default(i).toggleClass(Rt).trigger(r.default.Event(Ft, t)))
                }
            }, t.dispose = function() {
                r.default.removeData(this._element, Lt), r.default(this._element).off(jt), this._element = null, this._menu = null, null !== this._popper && (this._popper.destroy(), this._popper = null)
            }, t.update = function() {
                ...
                return this.each((function() {
                    ...
                    if (n || (n = new e(this, "object" == typeof t ? t : null), r.default(this).data(Lt, n)), "string" == typeof t) {
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                    for (var n = [].slice.call(document.querySelectorAll(Vt)), i = 0, o = n.length; i < o; i++) {
                        var a = e._getParentFromElement(n[i]),
                            s = r.default(n[i]).data(Lt),
                            l = {
                                relatedTarget: n[i]
                            };
                        if (t && "click" === t.type && (l.clickEvent = t), s) {
                            var u = s._menu;
                            if (r.default(a).hasClass(Rt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && r.default.contains(a, t.target))) {
                                var c = r.default.Event(Mt, l);
                                r.default(a).trigger(c), c.isDefaultPrevented() || ("ontouchstart" in document.documentElement && r.default(document.body).children().off("mouseover", null, r.default.noop), n[i].setAttribute("aria-expanded", "false"), s._popper && s._popper.destroy(), r.default(u).removeClass(Rt), r.default(a).removeClass(Rt).trigger(r.default.Event(Ft, l)))
                            }
                        }
                    }
                ...
                if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || r.default(t.target).closest(Xt).length) : !It.test(t.which)) && !this.disabled && !r.default(this).hasClass(Pt)) {
                    var n = e._getParentFromElement(this),
                        i = r.default(n).hasClass(Rt);
                    if (i || 27 !== t.which) {
        ...
        for (var r = (new window.DOMParser).parseFromString(e, "text/html"), i = Object.keys(t), o = [].slice.call(r.body.querySelectorAll("*")), a = function(e, n) {
                ...
                s.forEach((function(e) {
                    (function(e, t) {
                        ...
                        if (-1 !== t.indexOf(n)) return -1 === Tn.indexOf(n) || Boolean(Sn.test(e.nodeValue) || kn.test(e.nodeValue));
        ...
        zn = function() {
            ...
            return t.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    o.setAttribute("id", a), this.element.setAttribute("aria-describedby", a), this.setContent(), this.config.animation && r.default(o).addClass(Pn);
                    ...
                    if (r.default(this.tip).hasClass(Pn)) {
                ...
                if (r.default(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (r.default(n).removeClass(Rn), "ontouchstart" in document.documentElement && r.default(document.body).children().off("mouseover", null, r.default.noop), this._activeTrigger.click = !1, this._activeTrigger[Bn] = !1, this._activeTrigger[Fn] = !1, r.default(this.tip).hasClass(Pn)) {
                ...
                this.setElementContent(r.default(e.querySelectorAll(".tooltip-inner")), this.getTitle()), r.default(e).removeClass(Pn + " " + Rn)
                ...
                return Object.keys(t).forEach((function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), c.typeCheckConfig(Nn, e, this.constructor.DefaultType), e.sanitize && (e.template = An(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                null === e.getAttribute("x-placement") && (r.default(e).removeClass(Pn), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, e._jQueryInterface = function(t) {
                return this.each((function() {
                    var n = r.default(this),
                        i = n.data(Dn),
    ...
    r.default.fn[Nn] = zn._jQueryInterface, r.default.fn[Nn].Constructor = zn, r.default.fn[Nn].noConflict = function() {
        return r.default.fn[Nn] = jn, zn._jQueryInterface
    };
    var Vn = "popover",
        Xn = "bs.popover",
        Yn = "." + Xn,
        ...
        jr = function() {
            ...
            return t.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && r.default(this._element).hasClass(Er) || r.default(this._element).hasClass("disabled") || this._element.hasAttribute("disabled"))) {
                    ...
                    if (i) {
                        var a = "UL" === i.nodeName || "OL" === i.nodeName ? Lr : Dr;
                        n = (n = r.default.makeArray(r.default(i).find(a)))[n.length - 1]
                    }
                    var s = r.default.Event(Cr, {
                            relatedTarget: this._element
                        }),
                ...
                var i = this,
                    o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? r.default(t).children(Dr) : r.default(t).find(Lr))[0],
    ...
    r.default(document).on(Nr, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(e) {
        e.preventDefault(), jr._jQueryInterface.call(r.default(this), "show")
    })), r.default.fn[yr] = jr._jQueryInterface, r.default.fn[yr].Constructor = jr, r.default.fn[yr].noConflict = function() {
        return r.default.fn[yr] = wr, jr._jQueryInterface
    };
    var qr = "toast",
        Or = "bs.toast",
        Ir = "." + Or,
        ...
        Vr = function() {
            ...
            return t.show = function() {
                ...
                if (r.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                    ...
                    if (this._element.classList.remove(Rr), c.reflow(this._element), this._element.classList.add(Mr), this._config.animation) {
                ...
                return e = a({}, $r, r.default(this._element).data(), "object" == typeof e && e ? e : {}), c.typeCheckConfig(qr, e, this.constructor.DefaultType), e
            }, t._setListeners = function() {
                var e = this;
                ...
                var e = this,
                    t = function() {
                        e._element.classList.add(Rr), r.default(e._element).trigger(Wr)
                    };
    ...
    r.default.fn[qr] = Vr._jQueryInterface, r.default.fn[qr].Constructor = Vr, r.default.fn[qr].noConflict = function() {
        return r.default.fn[qr] = Pr, Vr._jQueryInterface
    }, e.Alert = y, e.Button = L, e.Carousel = re, e.Collapse = we, e.Dropdown = Gt, e.Modal = xn, e.Popover = nr, e.Scrollspy = vr, e.Tab = jr, e.Toast = Vr, e.Tooltip = zn, e.Util = c, Object.defineProperty(e, "__esModule", {
        value: !0
    })
})),
function(e, t) {
...
})), document.querySelector("#form-website") && document.querySelectorAll('input[name="privacy"]').forEach((function(e) {
    e.addEventListener("click", (function() {
